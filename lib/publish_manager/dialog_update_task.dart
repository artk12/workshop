...
class UpdateTask extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextEditingController expert = new TextEditingController(text: task.expertTime);
    TextEditingController amateur = new TextEditingController(text: task.amateurTime);
    TextEditingController intern = new TextEditingController(text: task.internTime);
                              ...
                              child: TextButton(
                                ...
                                onPressed: () async {
                                  if(itemName.text.isEmpty || expert.text.isEmpty || intern.text.isEmpty || amateur.text.isEmpty){
                                    ...
                                    String query = Update.updateTask(task.id,itemName.text, expert.text, amateur.text, intern.text);
                                    String res = await MyRequest.simpleQueryRequest('runQueryId.php', query);
                                    if(int.tryParse(res) != null){
                                      Task t = Task(id: task.id,internTime: intern.text,expertTime: expert.text,amateurTime: amateur.text,name: itemName.text);
